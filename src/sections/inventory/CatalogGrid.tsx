...
function ProductCard({ product, onStockChange, onEditClick, onDeleteClick }: {
  product: Product;
  onStockChange: (productId: string, newStock: number) => void;
  onEditClick: (product: Product) => void;
  onDeleteClick: (productId: string) => void;
...
export default function CatalogGrid({ products, onStockChange, onEditClick, onDeleteClick }: CatalogGridProps) {
